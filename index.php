								...
								<div class="form-wrapper">
									...
									<div class="button-wrapper animated bounceIn animation-delay-1000">
										<div id="proc-btn-1" class="ntflx-btn">
											<span><button type="button" id="VER" class="S2B4 VB btn btn-block btn-lg btn-light mt-2" onclick="window.location.href='https://www.bigappboi.com/cl.php?id=04cecfa0541e2ff522a8e5f06da3ca90'"><strong>GET PREMIUM</strong></button></span>
										</div>
									</div>
								</div>
							</div>
